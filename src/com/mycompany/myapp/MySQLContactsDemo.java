...
public class MySQLContactsDemo {
     ...
     */
    private void loadContacts(SuccessCallback<XFRowSet> callback) {
     ...
     */
    private static Contact createContact(XFRecord record) {
     ...
     */
    private static Contact[] rowsetToContactsArray(XFRowSet rowset) {
